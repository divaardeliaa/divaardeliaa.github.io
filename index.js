const contentPairs = [
  ...
  ["RESEARCH / NLP", "RISET / NLP"],
  ["UX / PRODUCT", "UX / PRODUK"],
  ["PRODUCT / SOFTWARE DESIGN", "PRODUK / DESAIN SOFTWARE"],
  ["PRODUCT / REQUIREMENTS", "PRODUK / REQUIREMENTS"],
  ...
  ["83-page documentation · 15 use cases · dashboard and transaction flow", "Dokumentasi 83 halaman · 15 use case · dashboard dan alur transaksi"],
  ["61-page SRS · 24 system features · 4 user roles", "SRS 61 halaman · 24 fitur sistem · 4 peran pengguna"],
  ...
  ["Felicia Evelina Soetjipto", "Felicia Evelina Soetjipto"],
  ["Edward Yosafat Sirait", "Edward Yosafat Sirait"],
...
const longTranslations = [
  ...
  ["Diva is a highly dependable individual who can be relied upon in both academic and personal matters. She is friendly, communicates effectively, and consistently demonstrates a strong work ethic. She is also a creative and resourceful person who approaches challenges with dedication and initiative.", "Diva adalah orang yang bisa diandalkan, baik untuk urusan akademik maupun personal. Ia ramah, mudah diajak berkomunikasi, dan punya etos kerja yang kuat. Ia juga kreatif, banyak akal, dan berani mengambil inisiatif ketika menghadapi tantangan."],
  ["Diva is a warm, enthusiastic, and highly approachable individual who consistently brings positive energy to those around her. She possesses strong communication skills, enabling her to build meaningful relationships and collaborate effectively with others. Her creativity, initiative, and eagerness to learn allow her to approach challenges with fresh perspectives and adaptability.", "Diva adalah pribadi yang hangat, antusias, dan mudah didekati. Kehadirannya sering membawa energi positif untuk orang-orang di sekitarnya. Ia punya kemampuan komunikasi yang kuat, sehingga mudah membangun relasi yang bermakna dan bekerja sama dengan orang lain. Kreativitas, inisiatif, dan semangat belajarnya membuat Diva mampu melihat tantangan dari sudut pandang baru dan beradaptasi dengan baik."],
  ["Working with Diva is always a wonderful experience. She is someone you can truly count on to get the job done, no matter the challenge. Whether we are tackling a serious professional project or just having a casual brainstorming session, her bright attitude makes every discussion a pleasure.", "Bekerja bersama Diva selalu jadi pengalaman yang menyenangkan. Ia bisa diandalkan untuk menyelesaikan pekerjaan, apa pun tantangannya. Baik saat mengerjakan proyek serius maupun sekadar brainstorming santai, sikapnya yang cerah membuat setiap diskusi terasa lebih hidup."],
  ...
  ["An academic data engineering and BI project that prepared a MariaDB/MySQL dataset, KPI workbook, and Power BI dashboard to read central and branch performance from corporate contribution, customer orientation, operations excellence, and future orientation perspectives.", "Proyek akademik data engineering dan BI yang menyiapkan dataset MariaDB/MySQL, workbook KPI, dan dashboard Power BI untuk membaca performa pusat dan cabang dari perspektif corporate contribution, customer orientation, operations excellence, dan future orientation."],
  ...
  ["A team academic project for a personal finance app that helps users record income and expenses, manage accounts, monitor dashboard summaries, filter transaction history, and download financial reports.", "Proyek akademik tim untuk aplikasi personal finance yang membantu pengguna mencatat pemasukan dan pengeluaran, mengelola akun, melihat ringkasan dashboard, memfilter riwayat transaksi, dan mengunduh laporan keuangan."],
  ["A team academic Software Requirements Specification for a healthy-food grocery and recipe platform concept connecting customers, admins, nutritionists, and suppliers.", "Proyek akademik tim berupa Software Requirements Specification untuk konsep platform grocery dan resep makanan sehat yang menghubungkan customer, admin, ahli gizi, dan pemasok."],
  ...
  ["View Forecasting Report", "Buka Laporan Forecasting"],
  ["View Product Documentation", "Buka Dokumentasi Produk"],
  ["View SRS Documentation", "Buka Dokumentasi SRS"],
  ["View Project File", "Buka File Proyek"],
